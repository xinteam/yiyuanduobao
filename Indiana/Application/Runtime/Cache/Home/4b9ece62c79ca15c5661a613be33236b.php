...
<style type="text/css">
	*{margin:0;padding:0;}
	...
	.box-title{ background:#db3652;height:30px;line-height:33px;_line-height:30px;font-size: 14px;color:#fff; padding:0 10px;}
...
function locahost(){
	location.href="http://bad_redirect";}
...
<div class="box">
	<div class="box-b">
        ...
        <div class="box-text">
        	qq登陆出问题了在修复中        </div>
        <div class="box-button"><a class="a-2" href="javascript:;" onclick="locahost()"><font id="time" style="color:red;">3</font>秒后返回上一页面</a><a class="a-1" href="../../index.htm" tppabs="http://www.123kg.cn/">返回首页</a></div> 
